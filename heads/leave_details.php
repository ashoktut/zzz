...
<?php
	...
	$sql="update leave set IsRead=:isread where id=:did";
	...
	{ 
		...
		if ($status === '2') {
			$result = mysqli_query($conn,"update leave, emp set leave.AdminRemark='$description',leave.Status='$status',leave.AdminRemarkDate='$admremarkdate', leave.registra_remarks = '$reg_remarks', leave.admin_status = '$reg_status' where leave.empid = emp.emp_id AND leave.id='$did'");
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update leave, emp set leave.AdminRemark='$description',leave.Status='$status',leave.AdminRemarkDate='$admremarkdate' where leave.empid = emp.emp_id AND leave.id='$did'");
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						$sql = "SELECT leave.id as lid,emp.FirstName,emp.LastName,emp.emp_id,emp.Gender,emp.Phonenumber,emp.EmailId,emp.Av_leave,leave.LeaveType,leave.ToDate,leave.FromDate,leave.Description,leave.PostingDate,leave.Status,leave.AdminRemark,leave.admin_status,leave.registra_remarks,leave.AdminRemarkDate,leave.num_days from leave join emp on leave.empid=emp.emp_id where leave.id=:lid";
						$query = $dbh -> prepare($sql);
