...
<?php
	...
	$status=1;
	 ...
	 $query = mysqli_query($conn,"select * from emp where EmailId = '$email'")or die(mysqli_error());
	...
	<?php
        ...
        mysqli_query($conn,"INSERT INTO emp(FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Av_leave,role,Phonenumber,Status, location) VALUES('$fname','$lname','$email','$password','$gender','$dob','$department','$address','$leave_days','$user_role','$phonenumber','$status', 'NO-IMAGE-AVAILABLE.jpg')         
		") or die(mysqli_error()); ?>
