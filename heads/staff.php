...
if (isset($_GET['delete'])) {
	$delete = $_GET['delete'];
	$sql = "DELETE FROM emp where emp_id = ".$delete;
			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_staff = mysqli_query($conn,"select * from emp where role = 'Staff' ")or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_hod = mysqli_query($conn,"select * from emp where role = 'HOD' ")or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_admin = mysqli_query($conn,"select * from emp where role = 'Admin' ")or die(mysqli_error());
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from emp LEFT JOIN dept ON emp.Department = dept.DepartmentShortName where emp.role = 'Staff' and emp.Department = '$session_depart' ORDER BY emp.emp_id") or die(mysqli_error());
