...
if(isset($_POST['new_update']))
{
    ...
    $result = mysqli_query($conn,"update emp set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Dob='$dob', Department='$department', Address='$address', Phonenumber='$phonenumber' where emp_id='$session_id'         
		")or die(mysqli_error());
    if ($result) {
...
if (isset($_POST["update_image"])) {
    ...
    $result = mysqli_query($conn,"update emp set location='$location' where emp_id='$session_id'         
		")or die(mysqli_error());
    if ($result) {
...
<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../vendors/images/saat.gif" alt=""></div>
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<?php $query= mysqli_query($conn,"select * from emp LEFT JOIN dept ON emp.Department = dept.DepartmentShortName where emp_id = '$session_id'")or die(mysqli_error());
										...
										<div class="tab-pane fade show active" id="timeline" role="tabpanel">
											<div class="pd-20">
												<div class="profile-timeline">
													<?php $query= mysqli_query($conn,"SELECT * from leave where empid = '$session_id'")or die(mysqli_error());
											...
											<div class="profile-setting">
												<form method="POST" enctype="multipart/form-data">
													<div class="profile-edit-list row">
														...
														<?php
														$query = mysqli_query($conn,"select * from emp where emp_id = '$session_id' ")or die(mysqli_error());
														$row = mysqli_fetch_array($query);
														?>
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<select name="department" class="custom-select form-control" required="true" autocomplete="off">
																	<?php
																		$query_staff = mysqli_query($conn,"select * from emp join  dept where emp_id = '$session_id'")or die(mysqli_error());
