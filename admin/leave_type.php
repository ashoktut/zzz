 ...
 if(isset($_POST['add']))
{
     ...
     $query = mysqli_query($conn,"select * from leavetype where LeaveType = '$leavetype'");
     ...
     if ($count > 0){ 
        ...
        $query = mysqli_query($conn,"insert into leavetype (LeaveType, Description, date_from, date_to)
