					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from emp LEFT JOIN dept ON emp.Department = dept.DepartmentShortName where role != 'Admin' ORDER BY emp.emp_id") or die(mysqli_error());
