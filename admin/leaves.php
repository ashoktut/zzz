					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php 
								$status=1;
								$sql = "SELECT leave.id as lid,emp.FirstName,emp.LastName,emp.location,emp.emp_id,leave.LeaveType,leave.PostingDate,leave.Status, leave.admin_status from leave join emp on leave.empid=emp.emp_id where leave.Status= '$status' order by lid desc limit 10";
